...
/**
 * Created by puneetkkala on 09/02/17.
 */

public class FrequentAdapter extends RecyclerView.Adapter<FrequentAdapter.ApplicationViewHolder> {
    ...
    public FrequentAdapter(Activity activity, TreeMap<String,ActivityInfo> applicationInfos, PackageManager pm) {
    ...
    @Override
    public FrequentAdapter.ApplicationViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_row,parent,false);
        return new FrequentAdapter.ApplicationViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(FrequentAdapter.ApplicationViewHolder holder, int position) {
